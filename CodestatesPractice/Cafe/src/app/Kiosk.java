...
import app.products.ProductRepository;
...
public class Kiosk {
    ...
    //**의존성주입**
    //app.Kiosk->cozDiscountCondition : 구현에 의존하고있다 구체클래스에 의존하고있다
    //app.Kiosk->DiscountCondition -> cozDiscountCondition : 역할에 의존하고있다
    ...
    private void order(Product selectedProduct) {
        //의존성주입
        //int price = cozDiscountCondition.app.discount(selectedProduct.getPrice());
        //int price = beDiscountCondition.app.discount(selectedProduct.getPrice());
